...
exports.config = {
  ...
  // specs: ["./features/login_pagii.feature"],
  // Patterns to exclude.
  exclude: [
  ...
  before: function (capabilities, specs) {
    ...
    browser.addCommand("clearBrowserData", function () {
      browser.url("about:blank"); // Open a blank page to ensure browser is initialized
      browser.deleteCookies(); // Delete all cookies
      browser.execute(() => {
